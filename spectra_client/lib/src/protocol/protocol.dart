...
import 'exception.dart' as _i17;
import 'filters.dart' as _i18;
import 'follower.dart' as _i19;
import 'media_type.dart' as _i20;
import 'model.dart' as _i21;
import 'models_list.dart' as _i22;
import 'presigned_url_request.dart' as _i23;
import 'presigned_url_response.dart' as _i24;
import 'search_vector_response.dart' as _i25;
import 'tag.dart' as _i26;
import 'tags_list.dart' as _i27;
import 'user.dart' as _i28;
import 'package:spectra_client/src/protocol/presigned_url_response.dart'
    as _i29;
import 'package:spectra_client/src/protocol/presigned_url_request.dart' as _i30;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i17.ServerSideException) {
      return _i17.ServerSideException.fromJson(data) as T;
    }
    if (t == _i18.ArtworkFilter) {
      return _i18.ArtworkFilter.fromJson(data) as T;
    }
    if (t == _i19.Follower) {
      return _i19.Follower.fromJson(data) as T;
    }
    if (t == _i20.MediaType) {
      return _i20.MediaType.fromJson(data) as T;
    }
    if (t == _i21.Model) {
      return _i21.Model.fromJson(data) as T;
    }
    if (t == _i22.ModelsList) {
      return _i22.ModelsList.fromJson(data) as T;
    }
    if (t == _i23.PresignedUrlRequest) {
      return _i23.PresignedUrlRequest.fromJson(data) as T;
    }
    if (t == _i24.PresignedUrlResponse) {
      return _i24.PresignedUrlResponse.fromJson(data) as T;
    }
    if (t == _i25.SearchVectorResponse) {
      return _i25.SearchVectorResponse.fromJson(data) as T;
    }
    if (t == _i26.Tag) {
      return _i26.Tag.fromJson(data) as T;
    }
    if (t == _i27.TagsList) {
      return _i27.TagsList.fromJson(data) as T;
    }
    if (t == _i28.User) {
    ...
    if (t == _i1.getType<_i17.ServerSideException?>()) {
      return (data != null ? _i17.ServerSideException.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i18.ArtworkFilter?>()) {
      return (data != null ? _i18.ArtworkFilter.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i19.Follower?>()) {
      return (data != null ? _i19.Follower.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i20.MediaType?>()) {
      return (data != null ? _i20.MediaType.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i21.Model?>()) {
      return (data != null ? _i21.Model.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i22.ModelsList?>()) {
      return (data != null ? _i22.ModelsList.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i23.PresignedUrlRequest?>()) {
      return (data != null ? _i23.PresignedUrlRequest.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i24.PresignedUrlResponse?>()) {
      return (data != null ? _i24.PresignedUrlResponse.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i25.SearchVectorResponse?>()) {
      return (data != null ? _i25.SearchVectorResponse.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i26.Tag?>()) {
      return (data != null ? _i26.Tag.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i27.TagsList?>()) {
      return (data != null ? _i27.TagsList.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i23.PresignedUrlRequest>) {
      return (data as List)
          .map((e) => deserialize<_i23.PresignedUrlRequest>(e))
          .toList() as T;
    }
    if (t == _i1.getType<List<_i24.PresignedUrlResponse>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i24.PresignedUrlResponse>(e))
              .toList()
          : null) as T;
    }
    if (t == _i1.getType<List<_i24.PresignedUrlResponse>?>()) {
    ...
    if (t == List<_i21.Model>) {
      return (data as List).map((e) => deserialize<_i21.Model>(e)).toList()
          as T;
    }
    if (t == _i1.getType<List<_i12.ArtworkTags>?>()) {
      return (data != null
    ...
    if (t == List<_i26.Tag>) {
      return (data as List).map((e) => deserialize<_i26.Tag>(e)).toList() as T;
    }
    if (t == _i1.getType<List<String>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<String>(e)).toList()
    ...
    if (t == List<_i29.PresignedUrlResponse>) {
      return (data as List)
          .map((e) => deserialize<_i29.PresignedUrlResponse>(e))
          .toList() as T;
    }
    if (t == List<_i30.PresignedUrlRequest>) {
      return (data as List)
          .map((e) => deserialize<_i30.PresignedUrlRequest>(e))
          .toList() as T;
    }
    try {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i17.ServerSideException) {
      return 'ServerSideException';
    }
    if (data is _i18.ArtworkFilter) {
      return 'ArtworkFilter';
    }
    if (data is _i19.Follower) {
      return 'Follower';
    }
    if (data is _i20.MediaType) {
      return 'MediaType';
    }
    if (data is _i21.Model) {
      return 'Model';
    }
    if (data is _i22.ModelsList) {
      return 'ModelsList';
    }
    if (data is _i23.PresignedUrlRequest) {
      return 'PresignedUrlRequest';
    }
    if (data is _i24.PresignedUrlResponse) {
      return 'PresignedUrlResponse';
    }
    if (data is _i25.SearchVectorResponse) {
      return 'SearchVectorResponse';
    }
    if (data is _i26.Tag) {
      return 'Tag';
    }
    if (data is _i27.TagsList) {
      return 'TagsList';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ServerSideException') {
      return deserialize<_i17.ServerSideException>(data['data']);
    }
    if (dataClassName == 'ArtworkFilter') {
      return deserialize<_i18.ArtworkFilter>(data['data']);
    }
    if (dataClassName == 'Follower') {
      return deserialize<_i19.Follower>(data['data']);
    }
    if (dataClassName == 'MediaType') {
      return deserialize<_i20.MediaType>(data['data']);
    }
    if (dataClassName == 'Model') {
      return deserialize<_i21.Model>(data['data']);
    }
    if (dataClassName == 'ModelsList') {
      return deserialize<_i22.ModelsList>(data['data']);
    }
    if (dataClassName == 'PresignedUrlRequest') {
      return deserialize<_i23.PresignedUrlRequest>(data['data']);
    }
    if (dataClassName == 'PresignedUrlResponse') {
      return deserialize<_i24.PresignedUrlResponse>(data['data']);
    }
    if (dataClassName == 'SearchVectorResponse') {
      return deserialize<_i25.SearchVectorResponse>(data['data']);
    }
    if (dataClassName == 'Tag') {
      return deserialize<_i26.Tag>(data['data']);
    }
    if (dataClassName == 'TagsList') {
      return deserialize<_i27.TagsList>(data['data']);
    }
