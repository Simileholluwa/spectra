...
--
-- Class Artwork as table artwork
--
...
--
-- Class ArtworkComment as table artwork_comment
--
...
--
-- Class ArtworkCommentLikes as table artwork_comment_likes
--
...
--
-- Class ArtworkDownloads as table artwork_downloads
--
...
--
-- Class ArtworkLikes as table artwork_likes
--
...
--
-- Class ArtworkModels as table artwork_models
--
...
--
-- Class ArtworkTags as table artwork_tags
--
...
--
-- Class ArtworkViews as table artwork_views
--
...
--
-- Class Follower as table follower
--
...
CREATE TABLE "user" (
    ...
    "email" text,
    "username" text,
    "bio" text DEFAULT 'Hello there, welcome to my profile!'::text,
...
--
-- Foreign relations for "artwork" table
--
...
--
-- Foreign relations for "artwork_comment" table
--
...
--
-- Foreign relations for "artwork_comment_likes" table
--
...
--
-- Foreign relations for "artwork_downloads" table
--
...
--
-- Foreign relations for "artwork_likes" table
--
...
--
-- Foreign relations for "artwork_models" table
--
...
--
-- Foreign relations for "artwork_tags" table
--
...
--
-- Foreign relations for "artwork_views" table
--
...
--
-- Foreign relations for "follower" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('spectra', '20250923122659182', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250923122659182', "timestamp" = now();
