...
--
-- Foreign relations for "model" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('spectra', '20250827124547769', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250827124547769', "timestamp" = now();
