...
part 'content_card_provider.g.dart';

@riverpod
class ContentCardNotifier extends _$ContentCardNotifier {
  @override
  ContentCardState build(ArtworkWithUserState? artworkState) {
    return ContentCardState.initial(artworkState);
  }
